...
public class NonMemberReportController {
    ...
    @RequestMapping(value = "/report/nonmember", method = RequestMethod.GET, produces = "application/pdf")
    public void generateReportMemberPerPeriode(@RequestParam(value = "mulai") Date mulai,
        ...
        List<NonMember> data = nonMemberRepository.cariNonMemberdari(mulai, akhir);

        InputStream jasperStream = this.getClass().getResourceAsStream("/reports/report_nonmember.jasper");
        ...
        response.setHeader("Content-disposition", "inline; filename=report_nonmember.pdf");
